...
class Image:
    ...
    async def imgur_random(self, ctx, *, term: str=None):
        ...
        try:
            ...
            await self.bot.say("Error: ai intazriat")
        else:
            if results:
                item = choice(results)
                ...
                await self.bot.say("niciun rezultat.")
    ...
    async def imgur_subreddit(self, ctx, subreddit: str, sort_type: str="top", window: str="day"):
        ...
        try:
            ...
            await self.bot.say("Error: Gata timpu, nimic")
            return
        ...
        async with aiohttp.get(url) as r:
            ...
            if r.status == 200:
                if result["data"]:
                    ...
                    await self.bot.say("Bye Bye rezultat.")
            else:
                await self.bot.say("erroare la API")
